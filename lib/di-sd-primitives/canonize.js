...
async function _customCanonize({document, options, labelMutator} = {}) {
  ...
  // FIXME: sort should either be unicode code point ... or should be based on
  // HMACing each N-Quad and sorting that way implies sending a relative index
  // for quad order as well
  mutated.sort();
